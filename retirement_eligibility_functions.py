...
class FERS:
    ...
    @staticmethod
    def deferred_retirement_eligibility(enp: EmployeeAttributes) -> bool:
        """
        Deferred Retirement
...
class CSRS:
    ...
    def early_retirement_eligibility(emp: EmployeeAttributes):
        return (emp.years_of_service >= 20 and emp.age >= 50) or (emp.years_of_service >= 25)

    """Special Provision Retirement
    Special Requirements: You must retire under special provisions 
        for air traffic controllers or law enforcement and firefighter personnel, nuclear materials courier
        , Supreme Court Police and Capitol Police.
    ...
    * ONLY air traffic controllers can retire at any age with 25 years of service as an air traffic controller.
    ...
    def special_provision(emp: EmployeeAttributes):
        return
